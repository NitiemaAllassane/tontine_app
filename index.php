   ...
   <main>
    <div class="max-w-2xl mx-auto py-24 px-6 md:px-0">
        ...
        <form action="./feats/admin/register_admin.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mt-6">
                <p class="text-center sm:text-start">Vous êtes déjà un compte ? <a href="./pages/connexion.php" class="text-purple-800 underline">Connectez-vous !</a> pour accéder à votre espace.</p>
            </div>
        </form>
    </div>
   </main>
